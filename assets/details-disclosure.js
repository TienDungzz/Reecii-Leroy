...
//       Motion.animate(this.elements.dropdown, { overflow: 'visible', opacity: [0, 1], visibility: 'visible' }, { duration: 0.3, delay: 0.2 });

//       Motion.animate(this.elements.dropdown.firstElementChild, { transform: [`${translateYIn}`, 'translateY(0px)'] }, { duration: 0.5 });
//     } else {
//       Motion.animate(this.elements.dropdown, { overflow: 'hidden', opacity: 0, visibility: 'hidden' }, { duration: 0.15 });
...
//       Motion.animate(
//         dropdown,
//         { opacity: [1, 0], visibility: 'hidden', overflow: 'hidden' },
